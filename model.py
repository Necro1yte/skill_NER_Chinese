...
from transformers import BertModel, BertConfig, ErnieForMaskedLM
...
#    self.bert_config = BertConfig.from_pretrained(args.bert_pretrained_dir)

#    testing stage
    self.bert_config = BertConfig.from_pretrained(args.bert_ner_dir)
